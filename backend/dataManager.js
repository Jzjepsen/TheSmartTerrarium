...
var _a = require('./db'), connect = _a.connect, getClient = _a.getClient; // db is our mongo connection module  
var client = mqtt.connect('mqtt://localhost:1883'); // replace with your mqtt broker details      
client.on('connect', function () {
    return __awaiter(this, void 0, void 0, function () {
        var dbClient, dbo, error_1;
                    ...
                    client.subscribe('terrariumData', function (err) {
                        if (!err) {
                            client.on('message', function (topic, message) {
                                ...
                                dbo.collection("Data").updateOne(query, newvalues, function (err, res) {
                                    if (err)
                                        throw err;
